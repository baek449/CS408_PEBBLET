...
public enum RuleCase {
	...
	player_multiple, player_current, player_all, player_exclude, player_left, player_right, player_left_all, player_right_all, player_satisfy, player_most, player_select,
	...
	num_size_player, num_size_deck, num_size_card, num_operation, num_call, string_raw, string_call
}
