...
public class rule_order_panel {
	...
	public rule_order_panel(){
		...
		order_panel.setLayout(new BoxLayout(order_panel, BoxLayout.LINE_AXIS));
	...
	public rule_order_panel(Node _input, final RuleManager rm){
		...
		order_panel.setLayout(new BoxLayout(order_panel, BoxLayout.LINE_AXIS));
		order_panel.add(order_ComboBox);
		order_panel.setMinimumSize(new Dimension(150,30));
		order_panel.setPreferredSize(new Dimension(150, 30));
	...
	public void addtoPanel(JComponent _panel, int x, int y ){
		//_panel.setLayout(new BoxLayout(order_panel, BoxLayout.LINE_AXIS));
		order_panel.setBounds(x,y,150,30);
